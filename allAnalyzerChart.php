...
$sql = "SELECT a.name analyzerName, SUM(valueunits) sumUnits FROM `analyzerreading` ar JOIN analyzer a ON a.id=ar.analyzerid GROUP BY analyzerid";
...
while($row = mysqli_fetch_assoc($result))
{
 ...
 $chart_data .= "{ analyzerName:'".$row["analyzerName"]."', sumUnits:".$row["sumUnits"]."}, ";
}
...
<html>
 ...
 <body>
  ...
  <?php
    $sql = "SELECT name FROM analyzer WHERE id='".$id."'";
$result = mysqli_query($conn, $sql);
...
<!--    <h3 align="center">..</h3>   --> 
   ...
   <div class="container" style="width:900px;">
   <h2 align="center">All Analyzers Comparison</h2>
<!--    <h3 align="center">..</h3>   --> 
   <br /><br />
   <div id="chart"></div>
  </div>
