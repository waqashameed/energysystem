...
$connect = mysqli_connect("localhost", "root", "", "uploadingdata");
$query = "SELECT * FROM tbl_excel";
                    ...
                    <ul class="page-sidebar-menu" id="menu">
                        ...
                        <li>
                            ...
                            <ul class="sub-menu">
                                ...
                                <li>                                 <a href="editable_table.html">                                     <i class="fa fa-angle-double-right"></i>                                     Editable Data Tables                                 </a>                             </li>                             <li>                                 <a href="responsive_tables.html">                                     <i class="fa fa-angle-double-right"></i>                                     Responsive Data Tables                                 </a>                             </li>
                            </ul>
                        </li>
                        <li>
                            <a href="#">
                        ...
                        <li>
                           ...
                           <ul class="sub-menu">                                 <li>                                     <a href="blog_list.html">                                         <i class="fa fa-angle-double-right"></i>                                         Blog Category List                                     </a>                                 </li>                                 <li >                                     <a href="blog_list2.html">                                         <i class="fa fa-angle-double-right"></i>                                         Blog List                                     </a>                                 </li>                                 <li>                                     <a href="add_newblog.html">                                         <i class="fa fa-angle-double-right"></i>                                         Add New Blog                                     </a>                                 </li>                             </ul>
                        </li>
                        <li>
                            <a href="#">
...
Morris.Bar({
 ...
 xkey:'excel_name',
 ykeys:['excel_email', 'excel_name'],
 labels:['MAIexcel_emailLS', 'excel_name'],
 hideHover:'auto',
 stacked:true
});
</script>
