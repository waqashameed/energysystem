...
if(isset($_POST['Submit']))
{
	...
	mysqli_query($con,"update userss set fname='$fname' ,lname='$lname' , contactno='$contact' where id='".$_GET['uid']."'");
...
<html lang="en">
  ...
  <section id="container" >
      ...
      <?php $ret=mysqli_query($con,"select * from userss where id='".$_GET['uid']."'");
